  ...
  return (
    <>
      <div>
        ...
        Welcome to Github Finder, a React app that helps you search GitHub profiles and access their repos. With GitHub-Finder, you can easily find and connect with other developers, discover new projects, and stay up-to-date on the latest
